...
const MyBlogs = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {blogs.map((blog) => {
  // console.log('Blog Status:', blog.blogStatus);  // Log blogStatus to verify
  return (
    <div key={blog.blogId} className="relative bg-white shadow-lg rounded-lg p-4 transition hover:shadow-xl">
      
      {/* Conditionally render "Deleted" in red when blogStatus === 0 */}
      {blog.blogStatus === 0 && (
